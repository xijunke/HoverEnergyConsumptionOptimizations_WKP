...
% if (R_wing+xr0-4.5*C_aver)>0 || (-R_wing-xr0+2.9*C_aver)>0 || (100*nu-2*PHI*f*R_wing1*C_aver1)>0 || (2*PHI*f*R_wing1*C_aver1-1000*nu)>0
if (100*nu-2*PHI*f*(R_wing1+xr01)*C_aver1)>0 || (2*PHI*f*(R_wing1+xr01)*C_aver1-3000*nu)>0
