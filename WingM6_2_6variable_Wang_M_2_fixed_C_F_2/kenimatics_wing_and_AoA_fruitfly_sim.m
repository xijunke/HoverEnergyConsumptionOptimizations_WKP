function wing_m_output=kenimatics_wing_and_AoA_fruitfly_sim(f,phi_m,K,eta_m,C_eta,Phi_eta)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% x =[169.2788,0.8352,0.0051,1.4008,-27.5777,-3.1144]; % 20160116-WingM6_2_6variable_Wang_M_2-计算结果
% f=x(1);
% phi_m=x(2);
% K=x(3);
% eta_m=x(4);
