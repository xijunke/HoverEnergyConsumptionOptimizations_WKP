...
% 建立约束之外的惩罚函数
% variable=[f,phi_m,K,eta_m,C_eta,Phi_eta];     % 6个变量
...
% UB = [300,pi/2,1,pi/2,200,pi,eta_0max];   % Upper bound   % 7个变量——注意3个数据修改上限,不同于2007-JFM-Wang ZJ
% LB = [0,0,0.0001,0,-inf,-pi/2];                   % Lower bound   % 6个变量[f,phi_m,K,eta_m,C_eta,Phi_eta]; 
% UB = [1000,pi/2,1,pi,inf,0];   % Upper bound % 6个变量[f,phi_m,K,eta_m,C_eta,Phi_eta]; —注意3个数据修改上限,不同于2007-JFM-Wang ZJ
LB = [0,      0,             0.0001, 0,    0,  -pi/2]; 
UB= [1000, 75*pi/180, 1,        pi/2, 5,  0]; 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% LB =[0,     0,    -pi, 0,    -pi,  -pi/4];              % Lower bound   % 6个变量
% UB=[300, pi/2, pi, pi/2, pi,   pi/4];              % Upper bound   % 6个变量
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
N=length(x);
con_min=LB;
con_max=UB;
