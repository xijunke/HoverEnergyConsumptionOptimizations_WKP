...
% x=[35.4018,1.5769,-0.5250,-0.3650,0.8572,-3.1414,0.0167,3.9583,1.8190,1.9995,-0.0486];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% x =[38.7818,1.5259,2.6496,0.9744,-0.0440,0.0015,3.6837,1.7620,2.0000,0.0055];% 10个变量
% P_asterisk =9.3866;   L =1.0000;    delta =-3.3726e-005;   penaltyfun1 =0.0675;   
% penaltyfun2 =0;      AR =3.2257;   Re =103.8108;        penaltyfun5 =0;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% x=[209.7713,0.7522,3.0866,1.1282,0.4909,0.0068];    % 6个变量
% P_asterisk =10.0143;  L =0.9999;   delta =-7.9186e-005;
% penaltyfun1 =0.1584;  penaltyfun2 =0;    penaltyfun5 =2000;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% x=[210.1233,0.7521,3.0971,1.1309,0.4864,0.0067];    % 6个变量
% P_asterisk =9.8024;      L =1.0004;              delta =4.2835e-004; 
% penaltyfun1 =0.8567;   penaltyfun2 =0;     penaltyfun5 =0;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% x=[127.5671,1.4443,2.2757,1.1398,-0.1799,-0.0203]; % 6个变量
% psi_0_deg=-0.0203*180/pi; % psi_0_deg =-1.1631;
...
% phi_m=pi/2;  
% K=0.704;  % K=0.0001;
% eta_m=72.7*pi/180;   % eta_m=45*pi/180;  
% C_eta=2.375; 
% Phi_eta=-72.4*pi/180;  %  Phi_eta=-pi/2;  
% eta_0=0;   % eta_0=pi/2;  
% x=[f,phi_m,K,eta_m,C_eta,Phi_eta,eta_0]; 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% f=234;          % P_asterisk=171.6391; L =3.6310;
% phi_m=pi/2;  % P_asterisk=171.6391; L =3.6310;
%%%%%%%%%%%%%%%%%%%%%%%%%
% f=182.4;        % P_asterisk=24.3485; L =1;
% phi_m=pi/3;  % P_asterisk=24.3485; L =1;
%%%%%%%%%%%%%%%%%%%%%%%%%
% f=188.7;             % P_asterisk=21.4094; L =1.2384;
% phi_m=1.1488;  % P_asterisk=21.4094; L =1.2384;
% % %%%%%%%%%%%%%%%%%%%%%%%%%
% K=0.0001;
% eta_m=1.0157;  % eta_m=45*pi/180;  
% C_eta=2.375; 
% Phi_eta=-pi/2;   % eta_0=0;
% x=[f,phi_m,K,eta_m,C_eta,Phi_eta]; 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% x =[169.2788,0.8352,0.0051,1.4008,-27.5777,-3.1144]; % fval =290.2787;
% % P_asterisk =14.4957;   L =1.0000;   delta = -2.2089e-006   % 负正组合虚质量力, 负转动环量力矩——XXX
% % P_asterisk =13.2925;   L =1.1160；delta =0.1160；             % 正正组合虚质量力, 负转动环量力矩——更合理些哦
% x =[144.5109,1.0640,0.1209,0.9782,-28.9946,-1.5854];  % fval =11.1469; % P_asterisk =11.1120;   L =1.0001;   delta =6.1121e-005;
% x =[144.6293,1.0884,0.9265,1.2201,-29.2724,-1.5427]; % fval =7.9466; % P_asterisk =7.9537; L =1.0000; delta =-1.0960e-006; Re =125.5466;
%%%%%%%%%%%%%%%%%%%%%%%%%%%
% x =[1.5593956e+2,1.2985792,4.2205976e-5,1.1087494,4.1524983e-1,-1.4416383]; % 为下一行的精确值 % C_maxyaxis=0.36;
% x =[155.9396,1.2986,0.0000,1.1087,0.4152,-1.4416];  % P_asterisk =19.4938; L =1.0000; delta =-4.4396e-005; AR =3.7643; Re =161.5046;
%%%%%%%%%%%%%%%%%%%%%%%%%%%
% x =[1.8433110e+002,1.1409700e+0,7.4265068e-001,1.1737824e+0,8.0448518e-008,-1.5684599e+0]; % 为下一行的精确值 % C_maxyaxis=0.36;
% x =[184.3311,1.141,0.7427,1.1738,0.0000,-1.5685];  % P_asterisk =17.3525; L =1.0000; delta =-8.5199e-009; AR =3.7643; Re =167.7386;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% x=[188.0,1.125,0.01,1.2201,5,-1.5427]; % P_asterisk =9.5589;L =1.0012; % C_maxyaxis=0.36; % P_asterisk =9.5682; L =1.0045; %C_maxyaxis=0.356737; 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% x=[169.55,1.1488,0.01,1.0157,2.5,-1.5427]; % P_asterisk =15.6817;L =1.0001;delta =9.2522e-005;
% x =[170.2694,1.1581,0.0001,1.0927,4.7195,-1.4926];%P_asterisk =12.4810; L =1.0000; delta =1.0834e-007; AR =3.7643; Re =157.2626; % 为下一行的精确值
% x=[1.7026941e+002,1.1580537e+0,1.0000010e-004,1.0927357e+0,4.7195217e+0,-1.4925868e+0];
% x =[172.3150,1.1515,0.0003,1.1034,4.4913,-1.5708]; % fval =11.7653; % P_asterisk =11.7517;L =1.0000;delta =-6.7235e-006; AR =3.7643; Re =158.2495;下一行是精确值：
% x =[1.7231496e+002,1.1514878e+0,2.7463158e-004,1.1033925e+0,4.4912664e+0,-1.5707963e+0];
% x =[153.50996,1.309,2.7463158e-004,1.1033925e+0,4.4912664e+0,-1.5707963e+0];% P_asterisk =12.0362; L =1.0000; delta =-5.6464e-006;
% x =[153.07496,1.309,2.7463158e-004,1.1033925e+0,4.8435708e+0,-1.5707963e+0]; % P_asterisk =11.9264; L =1.0000; delta =-4.0624e-005;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% tic
...
P_asterisk=P_total_aver/m_insect    % 量纲单位=uW/mg;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
L=F_vertical_aver/M_insectweight      % 无量纲: L =1.3940; 
