...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% f=234;          % P_asterisk=103.0602; L =3.48;
% phi_m=pi/2;  % P_asterisk=103.0602; L =3.48;
%%%%%%%%%%%%%%%%%%%%%%%%%
f=185.12;        % P_asterisk=15.4573; L =1.0001;
phi_m=pi/3;  % P_asterisk=15.4573; L =1.0001;
%%%%%%%%%%%%%%%%%%%%%%%%%
% f=188.7;             % P_asterisk=21.4711; L =1.2384;
% phi_m=1.1488;  % P_asterisk=21.4711; L =1.2384;   P_asterisk=21.4026(xxx,z轴方向的转动环量力矩方向有误)
%%%%%%%%%%%%%%%%%%%%%%%%%
K=0.0001;
