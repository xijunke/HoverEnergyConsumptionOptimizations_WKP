function wing_m_output=kenimatics_wing_and_AoA_fruitfly_sim()
...
% P_asterisk =17.0572;   L =1.0001;  delta =6.5845e-005;   
% penaltyfun1 =0.1317;  penaltyfun2 =0;  penaltyfun5 =0;  
% AR =3.7643;   Re =146.9455(132.4445);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
f=x(1);    % T=1/f;          % Hz
phi_m=x(2);
epsilon=x(3);
