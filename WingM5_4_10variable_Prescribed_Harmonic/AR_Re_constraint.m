...
C_aver=0.8854;  % mm
xr0=0.3289;
% C_maxyaxis=0.2024; %这里的扭转轴的位置采用了翅膀形貌学优化获得扭转轴的位置   % C_maxyaxis=0.25;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% % Re=100;  f=Re*nu/(2*PHI*R_wing1*C_aver1);   % f =121.0927Hz;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% if (R_wing+xr0-4*C_aver)>0 || (-R_wing-xr0+2.9*C_aver)>0 || (100*nu-2*PHI*f*R_wing1*C_aver1)>0 || (2*PHI*f*R_wing1*C_aver1-3000*nu)>0   
if (100*nu-2*PHI*f*R_wing1*C_aver1)>0 || (2*PHI*f*R_wing1*C_aver1-3000*nu)>0  % 这里的R_wing1应该换成(R_wing1+xr01)
