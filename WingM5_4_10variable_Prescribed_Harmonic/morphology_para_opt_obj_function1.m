...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% x=[127.25,1.5259,2.6496,0.9744,-0.0440,0.0015]; % 6个变量
% Rario_F_vertical_horiz_aver =1.3102;  F_vertical_to_horiz_rms =3.2251;
% P_aero_aver_to_inertia_aver =11.8690;  P_asterisk =23.8624;  L =1.0288;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 下面是20160106论文审稿意见回来之前的结果
